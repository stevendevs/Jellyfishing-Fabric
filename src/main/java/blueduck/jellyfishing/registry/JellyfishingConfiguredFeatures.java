...
public class JellyfishingConfiguredFeatures {
    ...
    public static final ConfiguredFeature<?, ?> CONFIGURED_CORALSTONE_REPLACEMENT = Feature.ORE.configure(new OreFeatureConfig(OreFeatureConfig.Rules.BASE_STONE_OVERWORLD, JellyfishingBlocks.CORALSTONE.getDefaultState(), 100)).range((new RangeDecoratorConfig(TrapezoidHeightProvider.create(YOffset.fixed(0), YOffset.fixed(0), 300)))).spreadHorizontally().repeat(250);
